package com.coat.ams.api.users;
...
public class AmsApiUsersApplication {

	@Autowired
	Environment environment;
	
	public static void main(String[] args) {
		SpringApplication.run(AmsApiUsersApplication.class, args);
		log.info("*** AmsApiUsersApplication is up!");
	}
